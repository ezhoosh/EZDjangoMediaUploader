...
from media_uploader_widget.admin import MediaUploaderInline, OrderedMediaUploaderInline
...
class InlineEditor(MediaUploaderInline):
...
class OrderedInlineEditor(OrderedMediaUploaderInline):
